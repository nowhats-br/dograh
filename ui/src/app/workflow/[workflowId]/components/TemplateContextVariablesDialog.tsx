    ...
    return (
        <Dialog open={open} onOpenChange={handleDialogOpenChange}>
            <DialogContent className="max-w-lg">
                <DialogHeader>
                    <DialogTitle>{t('workflow.templateVariables.title')}</DialogTitle>
                    <DialogDescription>
                        {t('workflow.templateVariables.description')}
                    </DialogDescription>
                </DialogHeader>
                <div className="space-y-4">
                    ...
                    {Object.entries(contextVars).length > 0 && (
                        <div className="space-y-2">
                            <Label className="text-sm font-medium">{t('workflow.templateVariables.currentVariables')}</Label>
                    ...
                    <div className="space-y-3">
                        <Label className="text-sm font-medium">{t('workflow.templateVariables.addNewVariable')}</Label>
                        <div className="space-y-2">
                            <div className="flex gap-2">
                                <div className="flex-1">
                                    <Label htmlFor="key" className="text-xs">{t('workflow.templateVariables.keyLabel')}</Label>
                                    <Input
                                        id="key"
                                        placeholder={t('workflow.templateVariables.keyPlaceholder')}
                                        value={newKey}
                                        onChange={(e) => setNewKey(e.target.value)}
                                    />
                                </div>
                                <div className="flex-1">
                                    <Label htmlFor="value" className="text-xs">{t('workflow.templateVariables.valueLabel')}</Label>
                                    <Input
                                        id="value"
                                        placeholder={t('workflow.templateVariables.valuePlaceholder')}
                                        value={newValue}
                            ...
                            >
                                {t('workflow.templateVariables.addVariable')}
                            </Button>
                        </div>
                    </div>
                </div>
                <DialogFooter>
                    <div className="flex items-center gap-2">
                        ...
                        <Button onClick={handleSave}>
                            {t('workflow.templateVariables.saveVariables')}
                        </Button>
                    </div>
                </DialogFooter>
            </DialogContent>
